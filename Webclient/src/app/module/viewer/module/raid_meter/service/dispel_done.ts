...
export class DispelDoneService implements OnDestroy {
    ...
    private initialize(): void {
        ...
        this.instanceDataService.get_dispels().pipe(take(1)).subscribe(dispels => {
    ...
    private commit(): void {
        commit_dispel(this.utilService, this.data$, this.units$,
            this.spell_casts, this.aura_applications, this.dispels, se_dispel(this.spell_casts, this.aura_applications));
    }
}
