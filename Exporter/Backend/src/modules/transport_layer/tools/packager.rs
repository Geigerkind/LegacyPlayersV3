use crate::modules::transport_layer::tools::{byte_reader, byte_writer, GUID};
use crate::modules::transport_layer::domain_value::MessageType;
use crate::modules::util::{salt_u64_u64, salt_u32_u64};
use std::sync::mpsc::Sender;

pub fn message_build(sender: Sender<(Vec<u32>, String)>) {
