...
use crate::modules::data::guard::{Language, Expansion};
...
pub fn get_character_item(me: State<Tooltip>, data: State<Data>, language: Language, expansion: Expansion, character_history_id: u32, item_id: u32) -> Result<Json<ItemTooltip>, Failure>
{
  me.get_character_item(&data, language.0, expansion.0, item_id, character_history_id).and_then(|tooltip| Ok(Json(tooltip)))
}
