...
pub fn get_character_item(me: State<Tooltip>, data: State<Data>, armory: State<Armory>, language: Language, expansion: Expansion, character_gear_id: u32, item_id: u32) -> Result<Json<ItemTooltip>, TooltipFailure>
{
