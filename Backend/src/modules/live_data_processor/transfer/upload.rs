...
pub fn upload_log(mut db_main: MainDb, me: State<LiveDataProcessor>, data: State<Data>, armory: State<Armory>) -> Result<(), LiveDataProcessorFailure> {
    let messages = WoWCBTLParser::new(&data, 6, 0, u64::MAX, 0).parse(&mut *db_main, &data, &armory, "/home/shino/Downloads/+0100_Hayleigh_000_100_Feierabend_2020_08_27_naxx_25.txt");
