...
pub trait GetCharacterItem {
    fn get_character_item(&self, db_main: &mut impl Select2, character_item_id: u32) -> Result<CharacterItem, ArmoryFailure>;
    fn get_character_item_by_value(&self, db_main: &mut impl Select2, character_item: CharacterItemDto) -> Result<CharacterItem, ArmoryFailure>;
}
