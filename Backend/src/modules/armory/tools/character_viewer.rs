...
impl CharacterViewer for Armory {
    fn get_character_viewer_by_history_id(
        ...
        let profession1 = character_history
            ...
            .and_then(|profession_id| {
                data.get_profession(profession_id).and_then(|profession| {
                    Some(CharacterViewerProfessionDto {
        ...
        Ok(CharacterViewerDto {
            ...
            guild: character_history.character_guild.and_then(|guild| {
                Some(CharacterViewerGuildDto {
            ...
            gear: CharacterViewerGearDto {
                ...
                head: character_history
                    ...
                    .as_ref()
                    .and_then(|inner| {
                        Some(character_item_to_character_item_viewer_dto(
                            data,
                            server.expansion_id,
                            inner,
                        ))
    ...
    fn get_character_viewer(
        ...
        return self.get_character_viewer_by_history_id(
            data,
            language_id,
