...
impl GetCharacterInfo for Armory {
    fn get_character_info(&self, character_info_id: u32) -> Result<CharacterInfo, ArmoryFailure> {
        ...
        self.db_main
            ...
            .unwrap_or_else(|| Err(ArmoryFailure::Database("get_character_info".to_owned())))
    }
