...
use crate::modules::armory::tools::{GetCharacter, GetCharacterFacial, GetCharacterInfo, GetGuild};
use crate::modules::armory::Armory;

pub trait GetCharacterHistory {
    fn get_character_history(
        &self,
        character_history_id: u32,
    ) -> Result<CharacterHistory, ArmoryFailure>;
    fn get_character_history_by_value(
        &self,
        character_id: u32,
...
impl GetCharacterHistory for Armory {
            ...
            &|mut row| {
                ...
                Ok(CharacterHistory {
                    ...
                    facial: row
                        ...
                        .unwrap()
                        .ok()
                        .and_then(|facial_id| self.get_character_facial(facial_id).ok()),
    ...
    fn get_character_history_by_value(
        ...
        let facial = character_history_dto
            .facial
            .as_ref()
