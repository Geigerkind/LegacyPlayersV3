...
function RPLL:PushCurrentInstanceInfo()
    ...
    if type ~= nil and type ~= "none" then
        ...
        this:PushExtraMessage(strjoin("&", name, type, difficultyIndex, difficultyName, maxPlayers, playerDifficulty, prep_value(found_instance_id)))
    end
end
